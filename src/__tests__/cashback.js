...
// status, amount, expected - попорядку из массива. (status, amount, expected) =>
// функция, которая должна выполняться
// handler (testing cashback function with %s status and %i amount) - prefix -
// описание каждого из теста
